...
function u(d,ap)
{
	...
	if(oe!=-1&&(oe<(kn||1)||zr.length>=(kn2||777000))){return zapisz()}ap.s++;setTimeout(()=>{psr(ap.s,u,ap)},pp+327)
	console.clear()
...
let kn=Number(prompt("na ilu plusach zatrzymać spisywanie rankingu? nie wpisuj 0 bo 0 plusów nigdy się nie kończy."))
let kn2=777000
if (!kn){kn=1;kn2=Number(prompt("ile pozycji pobrać?"))||77000}
